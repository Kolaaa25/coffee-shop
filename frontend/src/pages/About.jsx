...
const About = () => {
  return (
    <div className="animate-fade-in">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          <div className="mb-6 md:mb-8">
            <img src={coffeeIcon} alt="About Us" className="w-20 h-20 md:w-28 md:h-28 mx-auto animate-float" />
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif font-bold mb-4 md:mb-6 leading-tight">
            Our Story
          </h1>
          <p className="text-xl md:text-2xl lg:text-3xl mb-4 font-light">Crafting Excellence Since 2010</p>
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 mt-6 md:mt-8 max-w-lg mx-auto">
            <div className="glass-effect px-6 md:px-8 py-3 md:py-4 rounded-2xl backdrop-blur-md">
              <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-brown-light">15+</div>
              <div className="text-xs md:text-sm">Years Experience</div>
            </div>
            <div className="glass-effect px-6 md:px-8 py-3 md:py-4 rounded-2xl backdrop-blur-md">
              <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-brown-light">10K+</div>
              <div className="text-xs md:text-sm">Happy Customers</div>
            </div>
            <div className="glass-effect px-6 md:px-8 py-3 md:py-4 rounded-2xl backdrop-blur-md">
              <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-brown-light">50+</div>
              <div className="text-xs md:text-sm">Coffee Varieties</div>
            </div>
          </div>
        </div>
      ...
      {/* Our Mission */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-cream-light">
        <div className="container-custom max-w-5xl px-4">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4">
              <span className="text-brown-dark">Our Mission</span>
            </h2>
            <div className="w-16 md:w-24 h-1 bg-gradient-to-r from-brown to-brown-dark mx-auto rounded-full"></div>
          </div>
          
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-2xl p-6 md:p-12 hover-lift">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6 md:mb-8 text-center">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-primary via-primary-light to-brown text-cream relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 px-4">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4">Our Values</h2>
            <p className="text-lg md:text-xl text-cream-dark max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            {/* Sustainability */}
            <div className="text-center group hover-lift bg-white/10 p-6 md:p-10 rounded-2xl md:rounded-3xl glass-effect">
              <div className="mb-6 relative inline-block">
                <div className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-gradient-to-br from-brown to-brown-dark rounded-full flex items-center justify-center mx-auto shadow-2xl group-hover:animate-pulse-glow">
                  <svg className="w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 text-cream" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-cream-dark leading-relaxed text-base md:text-lg">
      ...
      <section className="py-16 md:py-20">
        <div className="container-custom px-4">
          <h2 className="section-title text-center mb-8 md:mb-12">Meet Our Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              >
                <div className="relative overflow-hidden rounded-full w-36 h-36 md:w-48 md:h-48 mx-auto mb-4">
                  <img
                    src={member.image}
                    alt={member.name}
      ...
      <section className="py-16 md:py-20 bg-cream">
        <div className="container-custom px-4">
          <h2 className="section-title text-center mb-8 md:mb-12">Our Coffee House</h2>
