// Centralized place for all icons and images in the project
// Simply replace the URL below with your image and it will automatically apply everywhere
...
export const { coffeeIcon, menuHeaderImage } = ICONS;
